            ...
            value: function render() {
                return React.createElement(
                    ...
                    React.createElement(
                        "form",
                        { method: "post", action: "#" },
                        React.createElement("input", { onChange: this.updateFeed.bind(this, "name"), type: "text", name: "query", id: "query", placeholder: "Feed Name" }),
                        React.createElement("br", null),
                        React.createElement("input", { onChange: this.updateFeed.bind(this, "url"), type: "text", name: "query", id: "query", placeholder: "Feed URL" }),
                        React.createElement("br", null),
                        React.createElement(
                            "button",
